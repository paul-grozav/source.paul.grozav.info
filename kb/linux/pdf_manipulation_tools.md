...
# Compress resulting PDF - this produces better results, by far: https://pdfcompressor.com/
...
1. https://www.ilovepdf.com/ - split, merge, compress(even embedded images are reduced in quality)
